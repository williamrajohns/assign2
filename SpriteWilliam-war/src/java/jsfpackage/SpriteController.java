...
import jsfpackage.util.JsfUtil;
import jsfpackage.util.PaginationHelper;
import beanpackage.SpriteFacade;
...
/**
 * Generated JSF page
 * contains many generated methods
 * and contains converter for the JSF color 
 * @author William
 */
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private beanpackage.SpriteFacade ejbFacade;
